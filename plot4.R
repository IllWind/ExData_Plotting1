...
plot(datetime,dataDT$Voltage,type="n",ylab="Voltage")
lines(datetime,dataDT$Voltage)
...
plot(datetime,dataDT$Global_reactive_power,type="n",ylab="Global_reactive_power")
lines(datetime,dataDT$Global_reactive_power)
